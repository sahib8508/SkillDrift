...
ALL_SKILLS = {
    ...
    "Cloud Platforms": [
        ...
        "CI/CD", "Load Balancing", "Monitoring", "Monitoring Tools",
    ],
    "Web & Other Technologies": [
        ...
        "OOP", "Agile", "Hibernate", "Maven", "JUnit", "Jest",
        "LLM", "Neural Networks",
        "Selenium", "JIRA", "Manual Testing", "TestNG", "Test Cases",
        "Test Automation", "API Testing", "Pytest", "Appium",
        "BDD", "Cucumber", "Mobile Testing", "Regression Testing",
        "SDLC", "STLC",
        "Incident Response", "Network Security", "Networking",
        "Compliance", "Threat Analysis", "Threat Detection",
        "Risk Assessment", "SIEM Tools", "Root Cause Analysis",
        "Vulnerability Assessment", "Kali Linux", "Wireshark",
        "Firewall", "Firewalls", "Incident Management", "ISO",
        "Figma", "Redux", "Responsive Design", "SEO", "WordPress",
        "MERN Stack",
        "Business Intelligence", "Data Visualization", "Data Mining",
        "Data Processing", "Data Cleansing", "Advanced Analytics",
        "Advanced Excel",
    ],
}
